...
export function classifyAudience(
  ...
  const secondary = determineSecondaryAudiences(
    primary,
    issueCategory,
    impactScope,
    explanation
 ...
 */
function determinePrimaryAudience(
  category: IssueCategory,
  scope: ImpactScope,
  explanation: ReproducibilityExplanation
): Audience {
 ...
 */
function determineSecondaryAudiences(
  primary: Audience,
  category: IssueCategory,
  scope: ImpactScope,
  explanation: ReproducibilityExplanation
): Audience[] {
  const secondary: Audience[] = [];
 ...
 */
function generateAudienceReason(
  primary: Audience,
  category: IssueCategory,
  scope: ImpactScope
): string {
  ...
  const scopeDescriptions: Record<ImpactScope, string> = {
 ...
 */
export function shouldSurfaceToHumans(
