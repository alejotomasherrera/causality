 ...
 */
export function classifyConsumption(stats) {
 ...
 */
export function calculateDeviation(observed, stats) {
    if (stats.stdDev === 0) {
 ...
 */
export function exceedsBaseline(observed, stats, stdDevThreshold) {
 ...
 */
export function calculateConfidence(sampleCount, deviation, minSamples) {
