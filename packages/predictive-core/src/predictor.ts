...
export class Predictor {
    private listeners: PredictionCallback[] = [];
    ...
    predict(input: PredictiveInput): PredictiveReport {
        const predictions: PredictiveOutput[] = [];
        ...
        for (const item of input.historicalReport.items) {
            ...
            const prediction: PredictiveOutput = {
    ...
    private emitPrediction(prediction: PredictiveOutput): void {
    ...
    private generateSummary(predictions: PredictiveOutput[]): string {
